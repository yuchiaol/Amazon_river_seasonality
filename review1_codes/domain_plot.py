...
# Read GECCO2 salinity data
       [ts_sss, lat_sss, lon_sss, so_mask] = read_gecco2_salinity(year_st,2016)   

# Read ECCO salinity data
       ts_sss_ecco = read_ecco_salinity(1992,2017)
...
# Arrange to monthly data
       ...
       prcp_gpcc_monthly = ts_gpcc.reshape((year_N,12))
       sss_monthly = ts_sss.reshape((year_N-2,12))
       sss_ecco_monthly = ts_sss_ecco.reshape(((2017-1992+1),12))
