...
def read_hybam_Orinoco_river(year_ed):
    ...
    filename = 'Orinoco_new_2013_2018.nc'
    ...
    river_discharge = f.variables['river_discharge'][:].data
    f.close()
...
if __name__ == '__main__':
    ...
    if ast.literal_eval(args.run_flag) == True:
       ...
       ts_river_dai = read_Dai_Trenberth_river_data(1979, year_ed-19, 2)/100000.

# Read Hybam Orinoco river data
       ts_river3 = read_hybam_Orinoco_river(2018)/100000.
       print(ts_river3)
