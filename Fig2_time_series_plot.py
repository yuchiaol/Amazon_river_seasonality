...
# Arrange max and min values
       ...
       [sss_soda_max, sss_soda_min] = max_min_select(sss_soda_monthly,year_N-1)
...
#       plt.xticks([1980, 1985, 1990, 1995, 2000, 2005, 2010],['','','','','','',''], fontsize=10)
       ...
       plt.plot(year,river3_max-river3_min, 'c-', linewidth=0.5, label='Dai-Trenberth')
...
#       plt.xticks([1980, 1985, 1990, 1995, 2000, 2005, 2010],['','','','','','',''], fontsize=10)
       ...
       tt_ecco = np.linspace(1992,year_ed,year_ed-1992+1)
       ax1 = fig.add_axes([0.13, 0.3, 0.35, 0.16])
       ax1.plot(year,sss_max,'b-',linewidth=0.5)
       corrcoef = np.polyfit(year[1:-1],sss_max[1:-1],1)
       ax1.plot(year[1:-1], corrcoef[0]*year[1:-1]+corrcoef[1], 'b-', linewidth=1)
       ax1.plot(year,sss_min,'b--',linewidth=0.5)
       corrcoef = np.polyfit(year[1:-1],sss_min[1:-1],1)
       ax1.plot(year[1:-1], corrcoef[0]*year[1:-1]+corrcoef[1], 'b--', linewidth=1)

       ax1.plot(tt_ecco,sss_ecco_max,'g-',linewidth=0.5)
       corrcoef = np.polyfit(tt_ecco[1:-1],sss_ecco_max[1:-1],1)
       ax1.plot(year[1:-1], corrcoef[0]*year[1:-1]+corrcoef[1], 'g-', linewidth=1)
       ...
       ax1.plot(year[1:],sss_soda_max,'r-',linewidth=0.5)
       corrcoef = np.polyfit(year[2:-1],sss_soda_max[1:-1],1)
       ax1.plot(year[1:-1], corrcoef[0]*year[1:-1]+corrcoef[1], 'r-', linewidth=1)
       ax1.plot(year[1:],sss_soda_min,'r--',linewidth=0.5)
...
#       plt.xticks([1980, 1985, 1990, 1995, 2000, 2005, 2010],['','','','','','',''], fontsize=10)
       ...
       ax1.plot(year,sss_max-sss_min,'b-',linewidth=0.5)
       corrcoef = np.polyfit(year[1:-1],sss_max[1:-1]-sss_min[1:-1],1)
       ax1.plot(year[1:-1], corrcoef[0]*year[1:-1]+corrcoef[1], 'b-', linewidth=1, label='GECCO2')
...
#       plt.axis([1979, 2014, 0.5, 3.5])
       ...
       ax1.plot(year[1:],sss_soda_max-sss_soda_min,'r-',linewidth=0.5)
       corrcoef = np.polyfit(year[2:-1],sss_soda_max[1:-1]-sss_soda_min[1:-1],1)
       ax1.plot(year[1:-1], corrcoef[0]*year[1:-1]+corrcoef[1], 'r-', linewidth=1, label='SODA3.1.1')
