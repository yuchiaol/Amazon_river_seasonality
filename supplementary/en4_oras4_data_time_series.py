...
# Read GECCO2 salinity data
       [ts_sss, lon_tmp, lat_sss, mask_tmp] = read_gecco2_salinity(year_st,year_ed)   
...
# Read ECCO salinity
       ts_ecco_sss = read_ecco_salinity(year_st,year_ed,mask_sss,lon_sss,lat_sss)
...
# Arrange to monthly data
       ...
       sss_monthly = ts_sss_rmean.reshape((year_N,12))
       ...
       sss_ecco_monthly = ts_ecco_sss_rmean.reshape((year_ed-1992+1,12))
...
# Arrange max and min values
       ...
       [sss_max, sss_min] = max_min_select(sss_monthly,year_N)
       print(sss_max.shape)
       print(year[1:-1])
       print(sss_max[1:-1])
       ...
       [sss_ecco_max, sss_ecco_min] = max_min_select(sss_ecco_monthly,year_ed-1992+1)
       print(sss_ecco_max.shape)
       print(year[14:-1])
       print(sss_ecco_max[1:-1])
       ts_temp = sss_ecco_max.copy()
       [reg, sig, pvalue] = statistical_f.linear_regression_1D_t_test_with_sample_size_adjusted(year[14:-1], ts_temp[1:-1], sig_level)
...
# ================================================================
       ...
       plt.plot(year,sss_en4_max,'r-',linewidth=0.5)
       corrcoef = np.polyfit(year[1:-1],sss_en4_max[1:-1],1)
       plt.plot(year[1:-1], corrcoef[0]*year[1:-1]+corrcoef[1], 'r-', linewidth=1) 
       plt.plot(year,sss_en4_min,'r--',linewidth=0.5)
       corrcoef = np.polyfit(year[1:-1],sss_en4_min[1:-1],1)
       plt.plot(year[1:-1], corrcoef[0]*year[1:-1]+corrcoef[1], 'r--', linewidth=1)
       plt.ylabel('(PSU)', fontsize=10)
       plt.axis([1979, 2014, 33, 36])
       plt.xticks([1980, 1985, 1990, 1995, 2000, 2005, 2010],['1980','1985','1990','1995','2000','2005','2010'], fontsize=10)
       plt.title('(a) EN4 5-meter Salinity Max and Min', fontsize=10)

       plt.axes([0.593, 0.7, 0.35, 0.2])
       plt.plot(year,sss_en4_max-sss_en4_min,'r-',linewidth=0.5)
       corrcoef = np.polyfit(year[1:-1],sss_en4_max[1:-1]-sss_en4_min[1:-1],1)
       plt.plot(year[1:-1], corrcoef[0]*year[1:-1]+corrcoef[1], 'r-', linewidth=1, label='EN4')
       plt.legend(fontsize=10, ncol=3, loc='upper left')
       plt.ylabel('(PSU)', fontsize=10)
       plt.axis([1979, 2014, 0.5, 2.5])
       plt.xticks([1980, 1985, 1990, 1995, 2000, 2005, 2010],['1980','1985','1990','1995','2000','2005','2010'], fontsize=10)
       plt.title('(b) EN4 5-meter Salinity Seasonality (Max. minus Min.)', fontsize=10)

       plt.axes([0.13, 0.4, 0.35, 0.2])
       plt.plot(year,sss_oras4_max,'r-',linewidth=0.5)
       corrcoef = np.polyfit(year[1:-1],sss_oras4_max[1:-1],1)
       plt.plot(year[1:-1], corrcoef[0]*year[1:-1]+corrcoef[1], 'r-', linewidth=1)
       plt.plot(year,sss_oras4_min,'r--',linewidth=0.5)
       corrcoef = np.polyfit(year[1:-1],sss_oras4_min[1:-1],1)
       plt.plot(year[1:-1], corrcoef[0]*year[1:-1]+corrcoef[1], 'r--', linewidth=1)
       plt.ylabel('(PSU)', fontsize=10)
       plt.axis([1979, 2014, 33, 36])
       plt.xticks([1980, 1985, 1990, 1995, 2000, 2005, 2010],['1980','1985','1990','1995','2000','2005','2010'], fontsize=10)
       plt.title('(c) ORAS4 5-meter Salinity Max and Min', fontsize=10)

       plt.axes([0.593, 0.4, 0.35, 0.2])
       plt.plot(year,sss_oras4_max-sss_oras4_min,'r-',linewidth=0.5)
       corrcoef = np.polyfit(year[1:-1],sss_oras4_max[1:-1]-sss_oras4_min[1:-1],1)
       plt.plot(year[1:-1], corrcoef[0]*year[1:-1]+corrcoef[1], 'r-', linewidth=1, label='ORAS4')
       plt.legend(fontsize=10, ncol=3, loc='upper left')
       plt.ylabel('(PSU)', fontsize=10)
       plt.axis([1979, 2014, 0.5, 2.5])
       plt.xticks([1980, 1985, 1990, 1995, 2000, 2005, 2010],['1980','1985','1990','1995','2000','2005','2010'], fontsize=10)
       plt.title('(d) ORAS4 5-meter Salinity Seasonality (Max. minus Min.)', fontsize=10)
       ...
       plt.axis([1979, 2014, 2.5, 4])
       plt.xticks([1980, 1985, 1990, 1995, 2000, 2005, 2010],['1980','1985','1990','1995','2000','2005','2010'], fontsize=10)
       plt.title('(a) GLEAM E Max and Min', fontsize=10)
       ...
       plt.legend(fontsize=10, ncol=3, loc='upper left')
       plt.ylabel('(mm/day)', fontsize=10)
       plt.axis([1979, 2014, 0.5, 1.5])
       plt.xticks([1980, 1985, 1990, 1995, 2000, 2005, 2010],['1980','1985','1990','1995','2000','2005','2010'], fontsize=10)
       plt.title('(b) GLEAM E Seasonality (Max. minus Min.)', fontsize=10)
